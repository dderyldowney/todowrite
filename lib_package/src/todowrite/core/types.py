...
- ToDoWrite Models: Core data structures for all task items
- Metadata: Extensible metadata system
- Command: Executable command definitions

Example:
    >>> from todowrite.core.types import Goal, LayerType, Metadata
    >>>
    >>> goal = Goal(
...
class Command(Base):
    ...
    ac_ref: Mapped[str | None] = mapped_column(
        String
    )  # AcceptanceCriteria reference
