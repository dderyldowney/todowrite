...
def extract_and_write_schema(markdown_path: Path, schema_output_path: Path) -> None:
    ...
    try:
        ...
        if match:
            ...
            print(f"✅ JSON schema extracted from {markdown_path} and written to {schema_output_path}")
        else:
...
if __name__ == "__main__":
    ...
    schema_file = project_root / "ToDoWrite" / "configs" / "schemas" / "todowrite.schema.json"
