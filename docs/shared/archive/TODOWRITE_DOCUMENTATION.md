...
export TODOWRITE_DATABASE_URL="postgresql://user:password@localhost:5432/todowrite"  # pragma: allowlist secret

# Standard database URL (fallback)
export DATABASE_URL="postgresql://user:password@localhost:5432/todowrite"  # pragma: allowlist secret
...
services:
  postgres:
    ...
    environment:
      ...
      POSTGRES_PASSWORD: todowrite_dev_password  # pragma: allowlist secret
    ports:
      - "5432:5432"
    volumes:
...
# Set environment
export TODOWRITE_DATABASE_URL="postgresql://username:password@localhost:5432/todowrite"  # pragma: allowlist secret
