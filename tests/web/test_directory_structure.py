...
class TestWebPackageBackendDirectoryStructure:
    ...
    def test_backend_directory_structure(self) -> None:
        ...
        backend_path: pathlib.Path = pathlib.Path("web_package/src/todowrite_web")
        assert backend_path.exists(), "web_package/src/todowrite_web directory should exist"
        assert backend_path.is_dir(), "web_package/src/todowrite_web should be a directory"

    def test_backend_src_structure(self) -> None:
        """RED: Test that backend/src/todowrite_web structure exists."""
        backend_src_path: pathlib.Path = pathlib.Path("web_package/src/todowrite_web")
        assert backend_src_path.exists(), "web_package/src/todowrite_web should exist"
        assert backend_src_path.is_dir(), "web_package/src/todowrite_web should be a directory"

    def test_backend_init_file_exists(self) -> None:
        """RED: Test that backend __init__.py exists."""
        init_path: pathlib.Path = pathlib.Path("web_package/src/todowrite_web/__init__.py")
        assert init_path.exists(), "web_package/src/todowrite_web/__init__.py should exist"
        assert init_path.is_file(), "web_package/src/todowrite_web/__init__.py should be a file"
    ...
    def test_backend_pyproject_toml_exists(self) -> None:
        ...
        pyproject_path: pathlib.Path = pathlib.Path("web_package/pyproject.toml")
        assert pyproject_path.exists(), "web_package/pyproject.toml should exist"
        assert pyproject_path.is_file(), "web_package/pyproject.toml should be a file"
    ...
    def test_backend_api_structure(self) -> None:
        ...
        api_path: pathlib.Path = pathlib.Path("web_package/src/todowrite_web/api")
    ...
    def test_backend_api_v1_structure(self) -> None:
        ...
        api_v1_path: pathlib.Path = pathlib.Path("web_package/src/todowrite_web/api/backend/v1")
        assert api_v1_path.exists(), "Backend API v1 directory should exist"
        assert api_v1_path.is_dir(), "Backend API v1 directory should be a directory"
    ...
    def test_backend_init_files_in_api_structure(self) -> None:
        ...
        api_inits: list[pathlib.Path] = [
            pathlib.Path("web_package/src/todowrite_web/api/backend/__init__.py"),
            pathlib.Path("web_package/src/todowrite_web/api/backend/v1/__init__.py"),
        ]

        for init_file in api_inits:
            assert init_file.exists(), f"API init file should exist: {init_file}"
            assert init_file.is_file(), f"API init should be a file: {init_file}"
