...
## 19. POSTGRESQL COLUMN DEFINITIONS - AUTHORITATIVE SYNTAX

**MANDATORY REQUIREMENT**: ALL agents MUST use correct PostgreSQL syntax for column definitions when writing PostgreSQL-compatible schemas.

### 19.1 PostgreSQL vs SQLite Column Syntax

**Auto-Incrementing Primary Keys:**
- **SQLite**: `id INTEGER PRIMARY KEY AUTOINCREMENT`
- **PostgreSQL**: `id SERIAL PRIMARY KEY` (ActiveRecord default)
...
### 19.2 PostgreSQL Identity Columns (SQL Standard)

**Syntax**: `GENERATED { ALWAYS | BY DEFAULT } AS IDENTITY [ ( sequence_options ) ]`

**Examples:**
```sql
-- ALWAYS prevents manual insertion unless OVERRIDING SYSTEM VALUE
id INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY

-- BY DEFAULT allows manual insertion
...
### 19.3 Common Column Types - PostgreSQL vs SQLite

**String Types:**
- **SQLite**: `VARCHAR(255)`, `TEXT`
- **PostgreSQL**: `VARCHAR(255)`, `TEXT` (same)
...
**Boolean Types:**
- **SQLite**: No native boolean (INTEGER 0/1)
- **PostgreSQL**: `BOOLEAN` (native true/false)

**Timestamp Types:**
- **SQLite**: `VARCHAR` (stored as ISO strings) or datetime functions
- **PostgreSQL**: `TIMESTAMP`, `TIMESTAMPTZ`, `DATE`

### 19.4 NOT NULL Constraints

**Both databases use NOT NULL syntax:**
```sql
...
**SQLite**: `DEFAULT 'pending'`
**PostgreSQL**: `DEFAULT 'pending'` (same syntax)

### 19.6 Authoritative PostgreSQL Documentation

- **Data Types**: <https://www.postgresql.org/docs/current/datatype.html>
- **CREATE TABLE**: <https://www.postgresql.org/docs/current/sql-createtable.html>
- **Identity Columns**: <https://www.postgresql.org/docs/current/ddl-default.html>
- **Numeric Types**: <https://www.postgresql.org/docs/current/datatype-numeric.html>
- **Rails PostgreSQL Guide**: <https://guides.rubyonrails.org/active_record_postgresql.html> (ActiveRecord specific PostgreSQL usage)

### 19.7 SQLAlchemy Mapping
...
**ALWAYS use SQLAlchemy models as the source of truth** - let SQLAlchemy generate the correct SQL for each database engine.

## 20. RAILS ACTIVERECORD API ENFORCEMENT - EXCLUSIVE USE ONLY
