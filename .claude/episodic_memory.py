...
from conversation_search import ConversationSearchSystem, SearchResult
...
class EpisodicMemory:
    ...
    def __init__(self, db_path: Optional[str] = None):
        ...
        if db_path:
            ...
            self.db_connection = os.getenv('EPISODIC_MEMORY_DB_PATH',
    ...
    def index_conversations(self, conversations_dir: str = None, force: bool = False) -> Dict[str, Any]:
    ...
    def search_conversations(self, query: str, limit: int = 10, message_type: str = None) -> List[Dict[str, Any]]:
        ...
        if args.index:
            ...
            if args.format == 'json':
                ...
                if result['success']:
                    ...
                    print(f"📊 Total: {result['total_conversations']} conversations, {result['total_messages']} messages")
            ...
            results = episodic.search_conversations(args.search, limit=args.limit, message_type=args.type)
