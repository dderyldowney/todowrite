-- ToDoWrite Database Schema with Core Fixes
-- Fixed: progress fields use INTEGER with proper constraints
-- Fixed: timestamps use proper TIMESTAMP WITH TIME ZONE
-- Compatible: status/severity/work_type use VARCHAR (CLI compatibility)
-- Fixed: All foreign keys are proper INTEGER types with CASCADE DELETE
